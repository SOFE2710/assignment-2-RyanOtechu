...
//Student joseph
            ...
            sofe2710.addStudentToCourse(joseph);
            ecse.registerStudentCourseInDepartment(joseph, sofe2710);
            joseph.registerFor(sofe2800);
            sofe2800.addStudentToCourse(joseph);
            ecse.registerStudentCourseInDepartment(joseph, sofe2800);
            joseph.registerFor(mane2200);
            mane2200.addStudentToCourse(joseph);
            amme.registerStudentCourseInDepartment(joseph, mane2200);


//Student Emily
            emily.registerFor(sofe2710);
            sofe2710.addStudentToCourse(emily);
            ecse.registerStudentCourseInDepartment(emily, sofe2710);
            emily.registerFor(sofe2800);
            sofe2800.addStudentToCourse(emily);
            ecse.registerStudentCourseInDepartment(emily, sofe2800);


//Student Max
            max.registerFor(mece3000);
            mece3000.addStudentToCourse(max);
            amme.registerStudentCourseInDepartment(max, mece3000);
            max.registerFor(sofe2800);
            sofe2800.addStudentToCourse(max);
            ecse.registerStudentCourseInDepartment(max, sofe2800);
            max.registerFor(sofe4610);
            sofe4610.addStudentToCourse(max);
            ecse.registerStudentCourseInDepartment(max, sofe4610);
            max.registerFor(elee4150);
            elee4150.addStudentToCourse(max);
            ecse.registerStudentCourseInDepartment(max, elee4150);

//Student Jane
            jane.registerFor(sofe2710);
            sofe2710.addStudentToCourse(jane);
            ecse.registerStudentCourseInDepartment(jane, sofe2710);
            jane.registerFor(mece3000);
            mece3000.addStudentToCourse(jane);
            amme.registerStudentCourseInDepartment(jane, mece3000);


//Student Chad
            chad.registerFor(mece3000);
            mece3000.addStudentToCourse(chad);
            amme.registerStudentCourseInDepartment(chad, mece3000);
            chad.registerFor(aute4010);
            aute4010.addStudentToCourse(chad);
            amme.registerStudentCourseInDepartment(chad, aute4010);
            chad.registerFor(aute3000);
            aute3000.addStudentToCourse(chad);
            amme.registerStudentCourseInDepartment(chad, aute3000);
            chad.registerFor(mane2200);
            mane2200.addStudentToCourse(chad);
            amme.registerStudentCourseInDepartment(chad, mane2200);
            chad.registerFor(sofe2710);
            sofe2710.addStudentToCourse(chad);
            ecse.registerStudentCourseInDepartment(chad, sofe2710);
